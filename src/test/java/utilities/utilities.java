...
public class utilities extends BaseClass{
	...
	public utilities(WebDriver driver) {
        this.driver = driver; // Correct usage
    }
	...
	// Press Enter key on a focused element or page
 ...
 // Select All (Ctrl+A) and Copy (Ctrl+C)
	...
	public void switchToTab(WebDriver driver,int tabNo) {
		...
		driver.switchTo().window(windw.get(tabNo));
	}
...
//		}
	...
	public boolean getCurrentURL(String expectedUrl) {
		...
		return text.contains(expectedUrl);
	}

	public boolean getPageContainsText(String expectedText) {
		String pageSource = driver.getPageSource();
		return pageSource.contains(expectedText);
	}
	
	// Exact match
	public boolean elementHasExactText(WebElement element, String expectedText) {
	...
	public boolean elementHasPartialText(WebElement element, String expectedText) {
	    if (element == null) return false;
	    String actualText = element.getText().trim();
	...
	public void waitFor(int timeInSeconds) {
		try {
			Thread.sleep(timeInSeconds * 1000L); // Convert seconds to milliseconds
